...
binwidth <- round((max(x1)-min(x1))/(Nbins-1) , 0)#el ancho de las clases
...
hist(x= as.double(x1[1]))
#no especificamos nº de clases, por defecto 10
hist(x1,Nbins) #especificamos nº de clases = Nbins
